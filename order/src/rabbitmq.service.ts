...
class RabbitMQService {
  ...
  //! NOTE: These are constants and should be the same in both services (publisher and consumer).
  private readonly exchangeName = "food_delivery_exchange"; // name of the exchange
  private readonly orderQueue = "order_queue"; // name of the order queue
  private readonly deliveryQueue = "delivery_queue"; // name of the delivery queue
